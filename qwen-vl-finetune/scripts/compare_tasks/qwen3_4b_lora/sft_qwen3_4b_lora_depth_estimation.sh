...
datasets="depth-estimation-train%100" # 使用你在 __init__.py 中注册的数据集名称
datasets_val="depth-estimation-val%100"

# Output configuration
run_name="qwen3vl_4b_lora-r32-a128_depth_estimation" # 描述性名称
